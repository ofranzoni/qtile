...
groups.append(ScratchPad('scratchpad', [
    DropDown('calendar', 'yad --no-buttons --calendar', x=0.015, y=0.01, width=0.2, height=0.2, opacity=0.9)
    ]
))
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                # widget.Net(interface="enp0s3", background="#00000000", foreground=foreground_colour, format=fa.icons["wifi"]+" {up}", **decor_Wifi),
                ...
                #widget.CheckUpdates(background="#00000000", foreground="#FF0000",colour_have_updates="#000000", colour_no_updates="#000000", **decor_ram),
                ...
                # widget.GenPollText(update_interval=60, func=lambda: "{}%".format(subprocess.check_output(os.path.expanduser("~/.config/qtile/Scripts/bat_poll")).decode("utf-8")), background="#00000000", foreground=foreground_colour, **decor_battery),
